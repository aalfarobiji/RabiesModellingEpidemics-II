...
base_path <- "D:/Kuliah/ResearchPractice/Model/Middle/Fatukopa/OzRab/results/default_results"
...
write_xlsx(combined_df, "D:/Kuliah/ResearchPractice/Model/Middle/Fatukopa/OzRab/scenario/Indonesia/allreport(dailyNumberReport)_middle.xlsx")
