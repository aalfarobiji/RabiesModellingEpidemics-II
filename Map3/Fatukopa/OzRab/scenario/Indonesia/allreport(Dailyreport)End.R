...
base_path <- "D:/Kuliah/ResearchPractice/Model/Additional 1/Fatukopa/OzRab/results/default_results"
...
write_xlsx(combined_df, "D:/Kuliah/ResearchPractice/Model/Additional 1/Fatukopa/OzRab/scenario/Indonesia/allreport(dailyNumberReport)_add1.xlsx")
