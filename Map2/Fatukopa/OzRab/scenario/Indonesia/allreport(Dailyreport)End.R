...
base_path <- "D:/Kuliah/ResearchPractice/Model/Low/Fatukopa/OzRab/results/default_results"
...
write_xlsx(combined_df, "D:/Kuliah/ResearchPractice/Model/Low/Fatukopa/OzRab/scenario/Indonesia/allreport(dailyNumberReport)_low.xlsx")
